        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className={`flex items-center ${i18n.language === "ar" ? "space-x-reverse space-x-3" : "space-x-3"}`}>
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-xl font-bold truncate">{t("header.title")}</h1>
              <p className="text-xs sm:text-sm text-blue-200 truncate hidden sm:block">{t("header.subtitle")}</p>
            </div>
          </div>
